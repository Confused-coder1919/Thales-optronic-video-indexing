...
DISCOVERY_MIN_CONSECUTIVE = int(os.getenv("ENTITY_INDEXING_DISCOVERY_MIN_CONSECUTIVE", "2"))
...
VERIFY_MIN_CONSECUTIVE = int(os.getenv("ENTITY_INDEXING_VERIFY_MIN_CONSECUTIVE", "1"))
...
OCR_MIN_CONSECUTIVE = int(os.getenv("ENTITY_INDEXING_OCR_MIN_CONSECUTIVE", "1"))
